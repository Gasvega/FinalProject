...
export default function FolderPost( {navigation,props} ) { 
    ...
    return (
      ...
      <ModernHeader title="글 작성" leftComponentDisable={leftComponent}  rightComponentDisable={RightComponent} rightImageSource={require("../../assets/check.png")} style={{backgroundColor:'#ffa7a7',height:90}} onLeftPress={() => navigation.navigate('FolderPostinglist')}  onRightPress={() => navigation.navigate('FolderPostinglist')} titleTextStyle={{top:15}} leftComponentStyle={{top:50}} rightComponentStyle={{top:50}}></ModernHeader>
       ...
       <TextInput
        ...
        <Image style={{width:200,marginLeft:50}} source={require("../../assets/camera.png")}/>
        </TouchableOpacity>
        </KeyboardAwareScrollView>
        </View>
    )
